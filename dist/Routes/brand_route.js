...
router.route('/')
    ...
    .post(auth_controller_1.protect, brand_controllers_1.uploadBrandImage, brand_controllers_1.resizeBrandImage, brand_validator_1.createBrandValidator, brand_controllers_1.createBrand);
