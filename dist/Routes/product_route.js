...
router.route('/').get(product_controllers_1.getProducts).post(product_controllers_1.uploadProductImages, product_controllers_1.resizeProductImages, product_validator_1.createProductValidator, product_controllers_1.createProduct);
