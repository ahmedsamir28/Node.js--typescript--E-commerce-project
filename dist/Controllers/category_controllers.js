...
exports.createCategory = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name } = req.body;
    const category = yield category_model_1.default.create({ name, slug: (0, slugify_1.default)(name) });
...
exports.getCategories = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const categories = yield category_model_1.default.find({}).skip(skip).limit(limit);
...
exports.updateCategory = asyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { name } = req.body;
    const categoryName = yield category_model_1.default.findById(id);
    ...
    const category = yield category_model_1.default.findByIdAndUpdate({ _id: id }, { name, slug: (0, slugify_1.default)(name) }, { new: true });
    if (!category) {
        return next(new apiError_1.default(`No category for this ID ${id}`, 404));
    }
    res.status(200).json({ success: true, data: category });
