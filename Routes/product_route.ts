...
import { createProduct, deleteProducts, getProducts, getSpecificProduct, resizeProductImages, updateProduct, uploadProductImages } from '../Controllers/product_controllers';
